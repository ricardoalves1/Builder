...
class Admin {
    ...
    void setPresident() {
        ...
        if (this.president == null) {
            ...
            System.out.println("President to be replaced: " + this.president.getName());
        }
        ...
        if (op == 'Y' || op == 'y') {
            ...
            this.president = (President) new PresidentBuilder()
                                .name(basicForm[0])
                                .email(basicForm[1])
                                .cpf(basicForm[2])
                                .phone(basicForm[3])
    ...
    void setCoach() {
        ...
        if (op == 'Y' || op == 'y') {
            String[] basicForm = form();
            System.out.print("Salary ");
            this.coach = (Coach) new CoachBuilder()
                                .name(basicForm[0])
                                .email(basicForm[1])
                                .cpf(basicForm[2])
                                .phone(basicForm[3])
    ...
    void setDoctor() {
        ...
        if (op == 'Y' || op == 'y') {
            ...
            System.out.print("Salary ");
            this.doctor = (Doctor) new DoctorBuilder(crm)
                                .name(basicForm[0])
                                .email(basicForm[1])
                                .cpf(basicForm[2])
                                .phone(basicForm[3])
    ...
    void addDriver() {
        ...
        System.out.print("Salary ");
        this.drivers.add(
                (Driver) new DriverBuilder(license)
                        .name(form[0])
                        .email(form[1])
                        .cpf(form[2])
                        .phone(form[3])
    ...
    void addPersonalTrainer() {
        ...
        System.out.print("Salary ");
        this.trainers.add(
                (PersonalTrainer) new PersonalTrainerBuilder()
                        .name(form[0])
                        .email(form[1])
                        .cpf(form[2])
                        .phone(form[3])
    ...
    void addPlayer() {
        ...
        System.out.print("Salary ");
        this.players.add(
                (Player) new PlayerBuilder(role, capable)
                        .name(form[0])
                        .email(form[1])
                        .cpf(form[2])
                        .phone(form[3])
    ...
    void addSupporter() {
        ...
        this.supporters.add(
                (Supporter) new SupporterBuilder(address, compliance, type)
                        .name(form[0])
                        .email(form[1])
                        .cpf(form[2])
                        .phone(form[3])
